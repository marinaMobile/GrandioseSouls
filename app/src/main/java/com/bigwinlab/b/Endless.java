...
import static com.bigwinlab.b.Global.FUNC_ID;
...
public class Endless extends AppCompatActivity {
    ...
    private static final String TAG = Endless.class.getSimpleName();
...
//                    animationView.setVisibility(View.INVISIBLE);
    ...
    public String yhgfxcbnmd(){
        ...
        String first1 = "http://";
        String second2 = "grandiosesouls.xyz/go.php?to=2&";
